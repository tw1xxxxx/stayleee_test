...
const faqs = [
  ...
  },
  {
    ...
    answer: "С увеличением суммы выкупа ваша персональная скидка будет расти. Это отобразится в вашем личном кабинете.",
  },
  {
    question: "Можно к вам приехать и посмотреть-потрогать товар без предварительного заказа/договоренности?",
    answer: "Конечно. Наш магазин находится по адресу: Переведеновский пер., 13с13, этаж 3 офис 19, Москва / график: с 12:00 – 17:00.",
  },
];

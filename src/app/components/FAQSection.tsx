...
const faqs = [
  {
    question: "Сколько времени займет изготовление заказа, если расчет на команду?",
  ...
  {
    question: "Что делать, если я не умею пользоваться размерной таблицей и нахожусь не в Москве?",
  ...
  },
  {
    ...
    answer: "Мы предоставляем скидки при заказе от 5 единиц товара. Чем больше заказ, тем выше скидка. Напишите нам в мессенджеры, и мы рассчитаем стоимость вашего заказа.",
  },
  {
    question: "Можно к вам приехать и посмотреть-потрогать товар без предварительного заказа/договоренности?",
    answer: "Конечно. Наш магазин находится по адресу: пер. Денисовский, д. 8/14, стр. 1 / график: с 12:00 – 17:00.",
  },
];
